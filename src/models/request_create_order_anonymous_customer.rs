...
/// RequestCreateOrderAnonymousCustomer : 'One-time' customer:  - should be used if a customer does not agree to take part in the store's loyalty programs or an aggregator (external system) does not provide customer details  - customer details will NOT be added to the store's customer database and will be used ONLY to complete the current order
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RequestCreateOrderAnonymousCustomer {
    /// Customer name.
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "type")]
...
impl RequestCreateOrderAnonymousCustomer {
    ...
    pub fn new(name: String, r#type: String) -> RequestCreateOrderAnonymousCustomer {
        RequestCreateOrderAnonymousCustomer { name, r#type }
    }
}

...
/// RequestCloseTableOrderRequest : Request for close table order.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RequestCloseTableOrderRequest {
...
impl RequestCloseTableOrderRequest {
    /// Request for close table order.
    pub fn new(organization_id: uuid::Uuid, order_id: uuid::Uuid) -> RequestCloseTableOrderRequest {
        RequestCloseTableOrderRequest {

...
pub struct StopListUpdateWebHookEventInfo {
    /// Event type.
    ...
    pub event_info: Option<Box<models::WebHookOnStopListChangeData>>,
}

impl StopListUpdateWebHookEventInfo {
    /// WebHook notification about stop list update.
    pub fn new() -> StopListUpdateWebHookEventInfo {

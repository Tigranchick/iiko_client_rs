...
/// OrderServiceOrderItem : Order item: service.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrderServiceOrderItem {
    /// Item.
    #[serde(rename = "service")]
    pub service: Box<models::OrderProduct>,
...
impl OrderServiceOrderItem {
    /// Order item: service.
    pub fn new(
        service: models::OrderProduct,
        cost: f64,
        r#type: String,

...
pub struct PersonalShiftWebHookEventInfo {
    /// Event type.
    ...
    pub event_info: Option<Box<models::PersonalShift>>,
}

impl PersonalShiftWebHookEventInfo {
    /// WebHook notification about employee personal shift update.
    pub fn new() -> PersonalShiftWebHookEventInfo {

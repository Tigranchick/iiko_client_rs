...
pub struct ReserveUpdateWebHookEventInfo {
    /// Event type.
    ...
    pub event_info: Option<Box<models::ReserveInfo>>,
}

impl ReserveUpdateWebHookEventInfo {
    /// WebHook notification about reserve update.
    pub fn new() -> ReserveUpdateWebHookEventInfo {

...
impl OrderAnonymousCustomer {
    ...
    pub fn new(name: String, r#type: String) -> OrderAnonymousCustomer {
        OrderAnonymousCustomer { name, r#type }
    }
}

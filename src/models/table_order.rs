...
pub struct TableOrder {
    ...
    pub customer: Option<Option<Box<models::OrderRegularCustomer>>>,
    ...
    pub when_created: Option<Option<String>>,
    /// Order waiter.
    #[serde(
        rename = "waiter",
        default,
    ...
    pub waiter: Option<Option<Box<models::OrderEmployee>>>,
    ...
    #[serde(
        rename = "splitOrderBetweenCashRegisters",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub split_order_between_cash_registers: Option<Option<models::SplitOrderBetweenCashRegisters>>,
    /// External menu ID.
    #[serde(
        rename = "menuId",
        default,
...
impl TableOrder {
    ...
    pub fn new(
        ...
        TableOrder {
            ...
            waiter: None,
            tab_name: None,
            split_order_between_cash_registers: None,
            menu_id: None,
            price_category: None,
            sum,
            number,
